...
public abstract class NakedAndAfraid extends JavaPlugin {
  ...
  protected TeleportHelper teleportHelper;
  ...
  protected TeamCommands teamCommands;

  protected TabListClearer tabListClearer;
   ...
   */
  protected boolean isAdventureSupported() {
   ...
   */
  protected void sendHelpMessage(@NotNull CommandSender sender, int page) {
